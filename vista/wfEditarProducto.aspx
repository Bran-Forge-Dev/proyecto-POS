<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="wfEditarProducto.aspx.cs" Inherits="POS.vista.wfEditarProducto" %>

<!DOCTYPE html>
<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
<meta charset="utf-8"/>
<title>NeoVenta - Editar Producto</title>
<link href="/contenido/css/estilo/editar-eliminar-productos.css" rel="stylesheet" />
    ...
    <div class="form-contenedor caja">
        <form id="formProducto">
            ...
            <div class="botones" style="justify-content: flex-end; gap: 18px; margin-top: 30px;">
                <button type="button" class="btn-guardar" onclick="guardarProductoEditado(event)">Guardar</button>
                <button type="button" class="btn-cancelar" onclick="window.location.href='wfProductos.aspx'">Cancelar</button>
            </div>
        </form>
    </div>

    <script src="/contenido/javascript/editarproductos.js"></script>
</body>
</html>
